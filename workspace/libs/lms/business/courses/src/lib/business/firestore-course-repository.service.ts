...
import { ServiceBase, SuccessApiResponse } from '@ngx-architecture/foundation';
...
import { Course, Video } from '@ngx-architecture/lms-common';
    ...
    this.courseCollection
      ...
      .then(response => {
        this.loggingService.log(
          ...
          `Preparing to process response to adding a new course to the database. ${course.title}`
        );
        if (response) {
