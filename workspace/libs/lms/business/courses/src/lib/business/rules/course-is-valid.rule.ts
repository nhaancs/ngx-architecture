    ...
    if (this.target !== undefined) {
      this.rules.push(
        new StringIsNotNullEmptyRange(
          'TitleIsValid',
          'The title value is not valid. Must be within 3 and 200 characters.',
          this.target.title,
          3,
          200,
          this.isDisplayable
      ...
      this.rules.push(
        new StringIsNotNullEmptyRange(
          'DescriptionIsValid',
          'The description value must with within 10 and 600 characters.',
      ...
      this.rules.push(
        new StringIsNotNullEmptyRange(
          'CategoryIsValid',
          'The required category value is not valid.',
